...
void btHashedOverlappingPairCache::processAllOverlappingPairs(btOverlapCallback* callback, btDispatcher* dispatcher)
{
	...
	// printf("b3HashedOverlappingPairCache m_overlappingPairArray.size()=%d\n",m_overlappingPairArray.size());
...
{
	// printf(" MyPairIndeSortPredicate  b3HashedOverlappingPairCache m_overlappingPairArray.size()=%d\n",m_overlappingPairArray.size());
